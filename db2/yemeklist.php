...
require_once 'db.php';
$SORGU = $DB->prepare("SELECT * FROM yemekmenusu WHERE id = 1"); //Bu satır, bir SQL sorgusu hazırlar. Bu sorgu, yemekmenusu tablosundan id değeri 1 olan satırı seçmeyi amaçlar.
$SORGU->execute();
$MENU = $SORGU->fetchAll(PDO::FETCH_ASSOC);//Bu satırda, sorgunun sonuçları bir dizi olarak alınır. 
// var_dump($MENU);
